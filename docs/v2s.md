...
## Before the fight:
<div style="color:red">Markers</div> should be placed in the four cardinal directions. Each party member should be assigned one of these four markers in order to handle several of the mechanics that occur throughout the fight. 
